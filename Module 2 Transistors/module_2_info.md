...
<p align="center"><em>Figure 1. Depletion MOSFET.</em></p>
...
<p align="center"><em>Figure 2. Enhancement MOSFET.</em></p>
...
<p align="center"><em>Figure 3. BJT schematic</em></p>
...
<p align="center"><em>Figure 4. BJT Circuit.</em></p>
...
<p align="center"><em>Figure 5. Current through resistor R5.</em></p>
...
### MOSFET
<p align="center">
  <img width="1919" height="896" alt="image" src="./images/mosfet_circuit.png" />
</p>

<p align="center"><em>Figure 7. MOSFET circuit: rectifier, DC bus, load resistor and gate driver.</em></p>

The schematic shows the complete system: an AC source is rectified and filtered to provide a DC bus, which powers a resistive load controlled by a low-side MOSFET. The gate of the MOSFET is driven by a pulse source through a gate resistor and a pull-down network.

---

<p align="center">
  <img width="1919" height="896" alt="image" src="./images/mosfet-gate-voltaje-current.png" />
</p>

<p align="center"><em>Figure 8. Gate voltage (V<sub>GS</sub>) and gate current (through R1).</em></p>

The waveform shows the applied gate voltage switching between 0 V and 5 V, while the gate current appears as narrow charging and discharging pulses limited by the gate resistor and the input capacitance of the MOSFET.

---

<p align="center">
  <img width="1919" height="896" alt="image" src="./images/mosfet-load-voltaje-current.png" />
</p>

<p align="center"><em>Figure 9. Load voltage (across R4) and load current (I(R4)).</em></p>

The results illustrate the switching behavior of the MOSFET: when the gate is high, the load voltage drops close to ground and the current rises according to Ohm’s law; when the gate is low, the MOSFET turns off, the load voltage returns to the DC bus level, and the current goes to zero.
